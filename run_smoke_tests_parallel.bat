@echo off
REM ===================================================================
REM Run Smoke Tests in Parallel and Generate HTML Report
REM ===================================================================

echo.
echo ===================================================================
echo   Parallel Smoke Test Execution
echo ===================================================================
echo.
...
REM Run smoke tests in parallel
echo.
echo [2/3] Running smoke tests in parallel...
echo.
py -B run_tests_parallel.py --tag smoke --format json --clean --generate-report
if errorlevel 1 (
    echo.
